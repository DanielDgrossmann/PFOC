...
def esforcos_de_calculo(base, altura, PDE, h_viga_x, h_viga_y, fck, nk, mk_y_topo1, mk_y_base1, mk_x_topo1,
    ...
    if relatorio:
        ...
        print(f'2 - Esforços característicos:\n'
        ...
        print(f'4 - Excentricidades de projeto (características): e1x = {e1x:.2f} cm - e1y = {e1y:.2f} cm;')
...
if __name__ == '__main__':
    ...
    SC = esforcos_de_calculo(22, 22, 280, 20, 20, 2, 100, 100, 100, 100, 100, relatorio=True)
